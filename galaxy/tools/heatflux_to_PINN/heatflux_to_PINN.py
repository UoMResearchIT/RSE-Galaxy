...
def vtkSearchPoints(aim_coor):
    ...
    # TODO: make better - finding some values (~20 in 18,000,000) that are out of range
    # so here just return that the heat flux at these are 0 - need to properly figure out why...
    if cell_id < 0:
        return 0
        # print(cell_id)
        # print(aim_coor)
