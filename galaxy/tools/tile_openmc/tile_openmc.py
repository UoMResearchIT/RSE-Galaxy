...
parser = argparse.ArgumentParser(
    ...
    description='OpenMC parametric CAD run script. Useage: python openmc_parametric.py <geometry file path> <config file path> <statepoint output file path>'
)
...
# os.rename(sp_file, statepoint_path) # TEMP FIX
